...
- そもそものパッチの影響で、ログインできない不具合があります。解決策など最新の情報は、[こちらをご覧ください](https://www.apkmirror.com/apk/x-corp/twitter/](https://github.com/crimera/piko/issues/714)) そもそも、私の環境ではログインできてないです。。。
