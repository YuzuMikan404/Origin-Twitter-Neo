...
参照元であったcrimeraさんのAPK更新が停止していたため、独自に参照元を[crimera/twitter-apk](https://github.com/crimera/twitter-apk/releases)から[lluni/twitter-apk](https://github.com/lluni/twitter-apk)にに変更してビルドしています。
**自己責任**にてご使用ください。
